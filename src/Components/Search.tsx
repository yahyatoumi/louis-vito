...
const Search:React.FC<NavProps> = (props) => {
    ...
    <div className="z-20 absolute top-0  w-screen flex justify-center items-center h-16 md:h-20 bg-white">
    ...
    <div
      className="z-10 absolute top-16 md:top-20 left-0 right-0 bottom-0 bg-black bg-opacity-40"
      onClick={() => {
        props.setSearch(false);
        document.body.style.overflowY = "scroll";
      }}
